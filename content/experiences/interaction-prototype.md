...
두 줄로 표시된 카드 제목과 본문 첫 줄이 겹쳐, 내용을 읽기 어려웠습니다.

![기존 슬라이드 · 제목과 본문이 겹치는 배치](/media/experiences/interaction-prototype/layout-overlap-before.png)

## 의도

완성된 슬라이드뿐 아니라 이후 내용을 바꾸고 출력하는 과정까지 고려했습니다.

**Technical Decision**

요소별 좌표를 지정하는 PPTX 생성 방식 대신 HTML·CSS의 Flex·Grid로 배치 관계를 정했습니다. 내용 길이가 달라져도 겹침을 줄이고, 공통 스타일로 여러 슬라이드를 함께 수정하기 쉬웠기 때문입니다.

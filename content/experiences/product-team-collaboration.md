...
팀원들이 같은 기준으로 답변을 검토하고 오류를 남길 수 있도록 QA 형식을 통일하고자 했습니다. ‘답변이 이상하다’는 의견을 어떤 값이 어떻게 다른지 드러나는 기록으로 바꿔, 수정 후에도 같은 조건으로 확인하는 것이 목표였습니다.

![공시 질문을 입력하는 웹 QA 화면](/media/experiences/product-team-collaboration/web-qa.png)

**Technical Decision**

질문·답변·공시 근거를 한 화면에서 비교하고 바로 오류를 남길 수 있게 했습니다. 값·단위·기간과 실행 버전을 항목별로 기록해, 다른 팀원도 어떤 부분을 다시 확인해야 하는지 알 수 있도록 했습니다.
